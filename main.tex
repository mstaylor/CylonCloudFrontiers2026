...
\begin{figure}[ht]
    ...
    \end{center}
    \caption{AllReduce Latency vs. Message Size. This figure shows the latency of the AllReduce collective operation across various message sizes for different worker counts on AWS Lambda.}
    \label{fig:allreducelatency}
\end{figure}
...
\begin{figure}[ht]
    ...
    \end{center}
    \caption{Barrier Latency vs. Node Count. This figure shows the scaling of barrier synchronization latency as the number of workers increases on AWS Lambda.}
