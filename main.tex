...
\hline
\textbf{Platform} & \textbf{Instance/Memory} & \textbf{Exec Time (s)} & \textbf{Billing Model} & \textbf{Cost (USD)} \\
\hline
AWS Lambda & 10 GB & 46.56 & Per-ms GB-s & \$0.032 \\
\hline
AWS EC2 & m3.xlarge (4 vCPU, 15 GB) & 41.84 & Per-s instance-hour & \$0.238 \\
\hline
\end{tabular}
\end{table}
