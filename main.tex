...
\begin{table}[ht]
\centering
\caption{Per-Execution Cost Comparison: 32-Worker Weak Scaling Join. Lambda cost (USD) = workers $\times$ memory(GB) $\times$ duration(s) $\times$ \$0.0000166667/GB-s. EC2 cost (USD) = instances $\times$ hourly\_rate $\times$ duration(h).}
